...
export abstract class DateAdapter<D, L = any> {
   ...
   */
  abstract setTime(target: D, hours: number, minutes: number, seconds: number): D;
   ...
   *     (type is implementation-dependent).
   */
  abstract parseTime(value: any, parseFormat: any): D | null;
   ...
   */
  abstract addSeconds(date: D, amount: number): D;
